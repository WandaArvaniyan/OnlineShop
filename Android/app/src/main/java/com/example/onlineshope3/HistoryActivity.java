...
public class HistoryActivity extends AppCompatActivity implements HistoryAdapter.HistoryAdapterCallback{
    ...
    List<ModelOnlineshop> modelLaundryList = new ArrayList<>();
    HistoryAdapter historyAdapter;
    OnlineshopViewModel laundryViewModel;
    ...
    private void setViewModel() {
        laundryViewModel = ViewModelProviders.of(this).get(OnlineshopViewModel.class);
    ...
    @Override
    public void onDelete(ModelOnlineshop modelLaundry) {
